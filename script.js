onload = function(){
    ...
    function gameLoop()
    {
        ...
        {
            // m.identity(c.mat);
            m.rotate(c.mat, 0.01, [0,1,0], c.mat);
        }
    ...
    function handleMouseMove(e) {
        ...
        if(MBUTTON == 2){
            ...
            m.multiply(newRotationMatrix, rightmouseRotationMatrix, rightmouseRotationMatrix);

            var vec3x = m.multiplyVec3(rightmouseRotationMatrix, [1, 0, 0]);
