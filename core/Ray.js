...
Ray.prototype = {
    intersectCube : function(cube) {
        // ray : r(t) = o + t * dir
        // plane : X * N = D
        // (o + t * dir) * N = D

        let matrix = [];
        matrixHelper.inverse(cube.getMatrix(), matrix);
        ...
        start = matrixHelper.multiplyVec3(matrix, start); // 变换到cube坐标系下
        end = matrixHelper.multiplyVec3(matrix, end);

        return this.intersectBox(start, end, cube.box, cube);
    },
    
	intersectBox: function ( start, end, box, target ) {
