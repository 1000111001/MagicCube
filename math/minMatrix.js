...
function matIV(){
	 ...
	 */
	this.multiplyVec3 = function(mat, vec, dest) {
	        if(!dest) { dest = vec }
	 ...
	 * dest if specified, vec otherwise
	 */
	this.multiplyVec4 = function(mat, vec, dest) {
	        if(!dest) { dest = vec }
	...
	this.getEularAngles = function(mat, vec){
		var angleX = Math.atan2(mat[9], mat[10]);
		var angleY = Math.atan2(-mat[8], Math.sqrt(mat[9]*mat[9], mat[10]*mat[10]));
